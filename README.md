...
7. Al pulsar la fecha actual se abre un pequeño diario en pantalla completa con tema oscuro. Cada nota se guarda de forma local y puede descargarse como archivo de texto.
