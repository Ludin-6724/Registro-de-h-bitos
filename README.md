...
7. Debajo del marcador de competencia aparece un mini calendario. Al hacer clic sobre un día se abre el diario en pantalla completa con tema oscuro. Este editor, centrado con márgenes laterales, permite añadir un **título** y una **lista de tareas** marcables. Las notas se guardan localmente y pueden descargarse como archivo de texto.
